...
*Kontext:* S-FIX-6 verlangt, dass der Kennwort-Reset alle Sitzungen widerruft. Beim Reset gibt es keine Sitzung: Der Nachweis ist ein eingelöstes Einmal-Token. Jede Repository-Methode auf `velve.session` verlangt aber einen `Actor`, und der einzige Erzeuger eines `Actor` ist laut E-93 die Sitzungsauflösung.
