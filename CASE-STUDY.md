...
*Grund:* Die Quantisierung erzeugte sichtbare Ringe im violetten Verlauf hinter dem Logo — genau die Artefaktklasse, für die weiche Verläufe anfällig sind. Rund 240 KB Ersparnis sind ein sichtbar beschädigtes Hero-Bild nicht wert. Verlustfrei bleiben 274 KB. Die zuerst notierte Begründung dafür — `oxipng` könne den durchgehend deckenden Alphakanal entfernen — war zu eng: Eine konstante Alphaebene komprimiert ohnehin auf fast nichts, und eine Messung mit erhaltenem Alphakanal liefert bytegleich dieselben 274,0 KB. Der Gewinn stammt aus der Neukomprimierung mit erschöpfender Filtersuche; die gelieferte Datei war schwach komprimiert. Der Wegfall des Alphakanals ist ein Nebeneffekt, nicht die Ursache.
