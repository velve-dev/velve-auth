...
*Grund:* (a) ist nicht möglich: `signOut` bekommt ein Token und sonst nichts; wer der Nutzer ist, steht erst in der Zeile, die gelöscht werden soll. (b) wäre genau das vorgelagerte `SELECT`, das S-OWNER-2 verbietet, und es machte aus einer Anweisung zwei mit einem Fenster dazwischen. Der Punkt ist ein anderer: Ein Sitzungstoken **ist** der Nachweis. Wer es vorlegt, hat die Sitzung; ein zusätzliches `user_id`-Prädikat prüfte nichts, was der Hash nicht schon geprüft hat. Das ist dieselbe Begründung, die das Einlösen eines Einmal-Tokens schon als benannte Ausnahme trägt, und sie steht jetzt als zweite benannte Ausnahme daneben — mit ihrem Grund, nicht als Lücke im Muster.
*Preis:* Zwei Ausnahmen in einer Prüfung, die von einer Ausnahme lebt. Jede weitere muss denselben Nachweis führen: Das Prädikat ist selbst ein Geheimnis. Sonst wird aus der benannten Ausnahme wieder die Liste, die sich in diesem Projekt schon zweimal als Loch erwiesen hat.
